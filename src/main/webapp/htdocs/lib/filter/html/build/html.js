angular.module('templates-main', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('/../../html/index',
    '<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title></title><!--<link href="../../../htdocs/css/global.debug.css" rel="stylesheet" />--><link href="css/filter.debug.css" rel="stylesheet"></head><body><div class="bread-crumbs"><div class="search-box"><i class="serach-icon"></i> <input id="search-order" type="text" placeholder="昵称 / 称号"></div><ul id="ul-path"><!--\n' +
    '                <li>\n' +
    '                    <ul>\n' +
    '                        #--breadCrumbs.begin--#\n' +
    '\n' +
    ...
    '                </div>\n' +
    '            </li>\n' +
    '        --></ul><script src="../../../htdocs/lib/jquery/jquery-1.11.1.debug.js"></script><script src="../../../htdocs/lib/miniquery/miniquery.debug.js"></script><script src="../../../htdocs/lib/sms/sms.debug.js"></script><script src="../../../htdocs/lib/datetimepicker/js/datetimepicker.mod.debug.js"></script><script src="js/DatetimePickerList.js"></script><script src="js/FilterData.js"></script><script src="js/FilterOptions.js"></script><script src="js/TimeZone.js"></script><script src="js/Path.js"></script><script src="js/Filter.js"></script><script src="js/Notification.js"></script><script src="login.js"></script></body></html>');
}]);
