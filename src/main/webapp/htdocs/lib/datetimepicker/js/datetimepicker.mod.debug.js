...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.language = options.language || this.element.data('date-language') || "zh-CN"; //改成 'zh-CN'
		...
		if (this.isInline) {
		    ...
		    this.picker.addClass('datetimepicker-dropdown-' + this.pickerPosition + ' datetimepicker-dropdown-menu');
		}
		if (this.isRTL) {
