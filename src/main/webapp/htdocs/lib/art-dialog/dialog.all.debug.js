    ...
    */
    define("popup", function (innerRequire) {
        ...
        $.extend(Popup.prototype, {
            ...
            show: function (anchor) {
                ...
                popup.addClass(this.className + '-show')
    ...
    define("dialog", function (innerRequire) {
        ...
        var artDialog = function (options, ok, cancel) {
            ...
            options = $.extend(true, {}, artDialog.defaults, options); //这里作了深度拷贝
            options.data = originalOptions.data; //by micty，这里确保跨页传过来的 data 是原引用，而不是新对象。
    ...
    define("dialog-plus", function (innerRequire) {
        ...
        dialog.oncreate = function (api) {
            ...
            if (url) {
                ...
                var sn = $.String.random();

                (function (data) { //by micty
                    ...
                    //这里要移除关联的 dialog 实例，否则内存无法释放
                    api.on('remove', function () {
                        IframeManager.removeData(key);
                    });
                ...
                $iframe.attr({
                    ...
                    api.__dispatchEvent('iframeload'); //by micty
