...
//提供快捷方式
    ...
    define('Object', function (require, module, exports) {
        ...
        module.exports = $.extend(exports, {
            ...
            /**
             * 获取一个对象的元素个数
             * @param obj Object} obj 要进行获取值的对象
             * @return 返回元素个数
             */
...
//包装类的实例方法
    ...
    define('Mapper', function (require, module, exports) {
        ...
        //实例方法
        $.extend(Mapper.prototype, {
            /**@lends MiniQuery.Mapper# */
