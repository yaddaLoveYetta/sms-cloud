 ...
 */
@Component
public class PartnerSupplierPlugin extends AbstractPlugInAdapter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // 供应商证件
        classIdSet.add(Constants.ClassType.PARTNER_SUPPLIER.classId());
    ...
    public List<Condition> getConditions(int classId, FormTemplate formTemplate, List<Condition> conditions) {
        ...
        if (userRoleType == Constants.UserRoleType.SYSTEM) {
            ...
            ret.add(new Condition().setFieldKey("type").setLogicOperator(Condition.LogicOperator.EQUAL).setValue(1));
