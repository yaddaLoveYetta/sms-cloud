...
public class MaterialController {
    ...
    public Map<String, Object> setImage(HttpServletRequest request, HttpServletResponse response, Integer classId,
            Long id) {
        ...
        for (Map.Entry<String, MultipartFile> fileEntry : files.entrySet()) {
            ...
            imageUrl = FileOperate.upload(file, fileHost, logoPath);
